...
import { Box, Paper, TableContainer, Table, TableRow, TableBody, TableCell, Avatar, Tabs, Tab } from '@mui/material'
...
const DetailModal = () => {
    ...
    useEffect(() => {
        ...
        const newBackgroundImageUrl = `/background/${randomIndex}.jpg`;
