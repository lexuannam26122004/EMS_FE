...
import { useUpdateTimeOffsMutation, useSearchTimeOffQuery, useGetByIdTimeOffsQuery } from '@/services/TimeOffService'
...
const UpdateTimeOff = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            await UpdateTimeOff(data).unwrap()
        } finally {
            setIsSaveLoading(false)
        }
        setIsSubmit(false)
        ...
        <Box sx={{ width: '720px', maxWidth: '100%', margin: '0 auto' }}>
            ...
            >
                <Typography sx={{ fontWeight: 'bold', fontSize: '22px', color: 'var(--text-color)' }}>
                    {t('COMMON.TIMEOFF.UPDATE.UPDATE_TIMEOFF')}
                </Typography>
